    ...
    public class HeadlinesDataHandler : DataHandler
    {
        ...
        private IList<Headline> GetHeadlinesFromSource(string Source)
        {
            ...
            if (htmlDoc.DocumentNode != null)
            {
                ...
                {
                    string ImageUrl = Node.Descendants("img").FirstOrDefault().Attributes.FirstOrDefault(a => a.Name == "data-src").Value.Split('?').First() + "?anchor=center&mode=crop&width=250&height=250";
