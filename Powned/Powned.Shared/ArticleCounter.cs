...
namespace Powned
{
    public static class ArticleCounter
    {
        ...
        {
            var messageDialog = new Windows.UI.Popups.MessageDialog("Wij bieden PowNed kostenloos aan en we zouden het op prijs stellen als u de PowNed app een positieve review geeft in de Windows store.", "Bedankt");
